describe Round do
  ...
  describe "#score" do
    it "returns 8 for rock vs paper" do
      expect(Round.new("A Y").score).to eq(8)
    end
    it "returns 1 for paper vs rock" do
      expect(Round.new("B X").score).to eq(1)
    end
    it "returns 6 for scissors vs scissors" do
